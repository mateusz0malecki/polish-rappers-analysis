...
class Musician(Base):
    ...
    artist_name = Column(String(32), unique=True)
    ...
    ranking_10000 = Column(Integer, nullable=True, default=None)
    ranking_20000 = Column(Integer, nullable=True, default=None)
    ranking_30000 = Column(Integer, nullable=True, default=None)
    ranking_all = Column(Integer, nullable=True, default=None)
